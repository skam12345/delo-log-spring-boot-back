...
@Setter
@Entity
@Table(name = "delo_2d_creation_table")
public class ImagePosting {
    ...
    @Column(name = "creation_image", columnDefinition = "TEXT")
    ...
    @Lob
    @Column(name = "creation_result_content", nullable = false, columnDefinition = "LONGTEXT")
